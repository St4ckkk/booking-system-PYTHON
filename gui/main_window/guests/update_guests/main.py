...
class UpdateGuests(Frame):
    ...
    def initialize(self):
        ...
        # Check if guests_data is iterable
        if isinstance(self.parent.guest_data, (list, tuple)):
            ...
            # Handle the case where guests_data is not iterable
            messagebox.showerror("Error", "Failed to fetch guest data. Please try again later.")
