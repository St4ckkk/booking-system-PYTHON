...
class UpdateReservations(Frame):
    ...
    def initialize(self):
        self.selected_r_id = self.parent.selected_rid
        if self.parent.reservation_data:  # Check if reservation data is available
            self.reservation_data = self.parent.reservation_data
            # Filter out all reservations for the selected reservation id
            ...
            print("No reservation data available.")  # Or handle this case accordingly
