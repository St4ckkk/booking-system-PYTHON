...
class Login(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Lianda - Booking System")
        ...
        self.canvas.create_text(
            ...
            150.0,
            anchor="nw",
            text="Lianda - Booking is a Hotel",
            fill="#FFFFFF",
